...
const enrichmentProviderSamples = ['Unknown', 'Other', 'Jira', 'ServiceNow', 'Slack', 'ASP', 'Internal', 'AlienVaultOTX', 'VirusTotal', 'AbuseIPDB', 'Splunk', 'Elastic', 'Microsoft Sentinel', 'CrowdStrike', 'Okta', 'AWS', 'Azure', 'Google Cloud', 'Cloudflare', 'Qualys', 'Tenable', 'MANUAL', 'MCP']
